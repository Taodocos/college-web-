<%@ Page Title="" Language="C#" MasterPageFile="~/registrar.master" AutoEventWireup="true" CodeBehind="department.aspx.cs" Inherits="SIMS_YY.department" %>
...
<table align="center" class="auto-style1">
    ...
    <tr>
        ...
        <td><div class="form.group">
            <asp:TextBox CssClass="form.control" ID="TextBox2" runat="server" placehold="" Width="252px" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
        </div></td>
    </tr>
     <tr>
